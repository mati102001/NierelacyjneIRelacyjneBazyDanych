...
public class RentRepositoryTest {
    ...
    void addTest() {
        ...
        Assertions.assertEquals(rent.getClient(), rr.get(rent.getRentId()).getClient());
        Assertions.assertEquals(rent.getField(), rr.get(rent.getRentId()).getField());
