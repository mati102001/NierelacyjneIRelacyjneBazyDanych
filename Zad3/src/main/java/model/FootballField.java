...
public class FootballField extends SportField implements Serializable {
    ...
    @JsonbProperty("gate_dimension")
    private String footballGateDimension;

    @BsonCreator
    @JsonbCreator
    public FootballField(@BsonProperty("surface") @JsonbProperty("surface") String surface, @BsonProperty("discipline") @JsonbProperty("discipline") String discipline, @BsonProperty("gate_dimension") @JsonbProperty("gate_dimension") String footballGateDimension, @BsonId @BsonProperty("id") String id) {
