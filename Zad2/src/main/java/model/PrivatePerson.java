...
public class PrivatePerson extends Client implements Serializable {
    ...
    @BsonCreator
    public PrivatePerson(@BsonProperty("phone_number") String phoneNumber, @BsonProperty("number_of_players") int numberOfPlayers, @BsonProperty("first_name") String firstName,
                         @BsonProperty("last_name") String lastName, @BsonId String id) {
