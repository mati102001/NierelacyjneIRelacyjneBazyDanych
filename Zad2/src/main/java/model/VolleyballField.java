...
public class VolleyballField extends SportField implements Serializable {
    ...
    @BsonCreator
    public VolleyballField(@BsonProperty("surface") String surface, @BsonProperty("discipline") String discipline, @BsonProperty("net_height") double netHeight, @BsonId String id) {
